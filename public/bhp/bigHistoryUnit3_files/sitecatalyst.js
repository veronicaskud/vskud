new SC_StubQP('bighistoryproject_s');
...
var s_account="bighistoryproject-prod"

if(location.href.indexOf("bhp3.bluerooster.com")>-1)
	s_account="bighistoryproject-dev"
if(location.href.indexOf("ppe.bighistoryproject.com")>-1)
	s_account="bighistoryproject-ppe"
if(location.href.indexOf("au.bighistoryproject.com")>-1)
	s_account="bighistoryproject-AU"
...
s.linkInternalFilters="javascript:,http://bhp3.bluerooster.com,https://course.bighistoryproject.com,"
...
s.clickPast(s.firstPage,'event13','event14');

/* Automate Campaign Tracking Code Extraction based on the WT.mc_id parameter*/ 
if(!s.campaign) 
...
s.visitorNamespace="bgc3"
s.trackingServer="metrics.bighistoryproject.com"
s.trackingServerSecure="smetrics.bighistoryproject.com"
s.visitorMigrationKey="53E4A114"
s.visitorMigrationServer="bgc3.d1.sc.omtrdc.net"
s.visitorMigrationServerSecure="bgc3.d1.sc.omtrdc.net"



s.setTagContainer("bighistoryproject_s");
